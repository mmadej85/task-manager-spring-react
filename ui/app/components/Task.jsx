...
export default class Task extends Component {
    ...
    render() {
        ...
        return <div id={parentId} className='task'>
            <a href='#' className='taskSubjectLine list-group-item' data-toggle='collapse' data-parent={parentRef}
               href={taskContentRef}
            ...
            <div className='taskContent list-group collapse' id={taskContentId}>
